...
import de.uniba.rz.amqpbackend.AMQPRemoteAccess;
import de.uniba.rz.jaxrsbackend.RestRemoteAccess;
import de.uniba.rz.udpbackend.UdpRemoteAccess;
...
public class TicketServerMain {
	...
	private static List<RemoteAccess> getAvailableRemoteAccessImplementations(String[] args) {
		...
		// e.g.:
		//implementations.add(new UdpRemoteAccess(args[0]));
		//implementations.add(new GrpcRemoteAccess(args[0], args[1]));
		//implementations.add(new AMQPRemoteAccess(args[0], args[1], args[2]));
